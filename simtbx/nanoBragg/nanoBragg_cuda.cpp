...
extern "C"
void add_nanoBragg_spots_cuda_update_cu(
    int spixels,
    int fpixels,
    int roi_xmin,
    int roi_xmax,
...
// new CUDA path
void
nanoBragg::add_nanoBragg_spots_cuda_update() {
  /*
     water_size not defined in class, CLI argument, defaults to 0
  */
  double water_size = 0.0;
...
#ifdef HAVE_NANOBRAGG_SPOTS_CUDA
  add_nanoBragg_spots_cuda_update_cu(
                   spixels,
                   fpixels,
                   roi_xmin,
                   roi_xmax,
                   ...
                   detector_thicksteps,
                   detector_thick,
                   detector_attnlen /* detector_mu */,
                   sdet_vector,
                   fdet_vector,
                   odet_vector,
                   pix0_vector,
                   curved_detector /* bool */,
                   distance,
                   close_distance,
                   beam_vector,
                   Xbeam,
                   ...
                   cpo);
#else
  throw SCITBX_ERROR("no CUDA implementation of add_nanoBragg_spots_cuda_update");
#endif
}
